...
function LoginForm() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50">
      <div className="relative w-full max-w-sm rounded-xl bg-white p-8 shadow-lg text-center">
        ...
        <h1 className="mb-2 text-xl font-bold text-zinc-900">{isPortfolio ? t("my_portfolio") : t("app_title")}</h1>
        <p className="mb-8 text-sm text-zinc-500">
          {isPortfolio ? t("login_portfolio_desc") : t("login_dashboard_desc")}
        </p>
