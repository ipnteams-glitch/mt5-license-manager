    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-rose-50 via-white to-amber-50 p-4">
        <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl border border-rose-200">
          ...
          <button onClick={() => window.location.href = window.location.origin + "/dashboard"} className="mt-3 w-full text-sm text-zinc-400 hover:underline">
            Back to Dashboard
          </button>
        </div>
      </div>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-rose-50 via-white to-amber-50 p-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-xl border border-rose-200 text-center">
        ...
        <button onClick={() => window.location.href = window.location.origin + "/dashboard"} className="mt-6 rounded-lg bg-blue-600 px-6 py-2.5 text-sm font-semibold text-white hover:bg-blue-700">
          Go to Dashboard
        </button>
      </div>
    </div>
